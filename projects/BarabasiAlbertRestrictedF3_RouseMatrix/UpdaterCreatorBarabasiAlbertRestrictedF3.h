...
#ifndef LEMONADE_UPDATER_CREATOR_BARABASI_ALBERT_RESTRICTEDF3_H
#define LEMONADE_UPDATER_CREATOR_BARABASI_ALBERT_RESTRICTEDF3_H
/**
 * @file
 *
 * @classUpdaterCreatorChainWalkingTertiaryBondWalking
 *
 * @brief create Updater for Barabasi-Albert model with restricted functionality f<=3
 * 
 * @details Barabasi-Albert model with restricted functionality f<=3
 *
...
class UpdaterCreatorBarabasiAlbertRestrictedF3 : public UpdaterAbstractCreate<IngredientsType> {
    typedef UpdaterAbstractCreate<IngredientsType> BaseClass;

public:
    UpdaterCreatorBarabasiAlbertRestrictedF3(IngredientsType& ingredients_, uint32_t _maxnumbermonomers, uint32_t _box_x = 128, uint32_t _box_y = 128, uint32_t _box_z = 128);
 ...
 */
template < class IngredientsType >
UpdaterCreatorBarabasiAlbertRestrictedF3<IngredientsType>::UpdaterCreatorBarabasiAlbertRestrictedF3(IngredientsType& ingredients_, uint32_t _maxnumbermonomers, uint32_t _box_x, uint32_t _box_y, uint32_t _box_z) :
 ...
 */
template < class IngredientsType >
void UpdaterCreatorBarabasiAlbertRestrictedF3<IngredientsType>::initialize() {
 ...
 */
template < class IngredientsType >
bool UpdaterCreatorBarabasiAlbertRestrictedF3<IngredientsType>::execute() {
    std::cout << "executeUpdaterCreatorBarabasiAlbertRestrictedF3" << std::endl;
    ...
    do {
        ...
        if (ingredients.getMolecules().getNumLinks(randNodeIdx) < 3) {
...
template<class IngredientsType>
bool UpdaterCreatorBarabasiAlbertRestrictedF3<IngredientsType>::addMonomerToParentWithProbability(uint32_t parent_id, int32_t type) {
 ...
 */
template < class IngredientsType >
void UpdaterCreatorBarabasiAlbertRestrictedF3<IngredientsType>::cleanup() {
    ...
    commentHG_FunctionalityNodes << " File produced by analyzer UpdaterCreatorBarabasiAlbertRestrictedF3" << std::endl
...
#endif /* LEMONADE_UPDATER_CREATOR_BARABASI_ALBERT_RESTRICTEDF3_H */
