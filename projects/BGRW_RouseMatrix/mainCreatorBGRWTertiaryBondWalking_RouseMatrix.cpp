...
#include "UpdaterCreatorBGRWTertiaryBondWalking.h"
...
int main(int argc, char* argv[])
{
  try{
    ...
    UpdaterCreatorBGRWTertiaryBondWalking<Ing> U_CW(myIngredients, number_of_monomers, probability, probabilityTertiaryWalk, box, box, box);
